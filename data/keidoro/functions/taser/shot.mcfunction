#矢の召喚
execute anchored eyes run summon arrow ^ ^ ^1 {life:1200s,damage:1d,Color:0,Tags:["tgar","tgop"],CustomName:'{"text":"電極","color":"yellow","italic":false}',CustomPotionEffects:[{Id:2,Amplifier:5b,Duration:60},{Id:8,Amplifier:-125b,Duration:20},{Id:29,Amplifier:0b,Duration:600,ShowParticles:1b}]}
